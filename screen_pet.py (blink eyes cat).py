...
mouth_happy = c.create_line(340, 500, 400, 564, 460, 500, smooth=1, width=2, state=HIDDEN)
mouth_sad = c.create_line(340, 500, 400, 464, 460, 500, smooth=1, width=2, state=HIDDEN)
cheek_left = c.create_oval(140, 360, 240, 460, outline='pink', fill='pink', state=HIDDEN)
cheek_right = c.create_oval(560, 360, 660, 460, outline='pink', fill='pink', state=HIDDEN)
